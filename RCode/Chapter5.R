...
dig <- 0
cap <- c("Results from trading System 1 using the forecasts generated by the ARIMA models.",
         "Results from trading System 1 using the forecasts generated by the ARIMA models")
...
dig <- 0
cap <- c("Results from trading System 2 using the forecasts generated by the ARIMA models.",
         "Results from trading System 2 using the forecasts generated by the ARIMA models")
