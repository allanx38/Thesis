...
dat <- res_diff3
dig <- 0
cap <- c("PL from Naive Reversing system subtracted from results generated by a trading system based on ARIMA/ANN closing price forecasts.",
...
dig <- 0
cap <- c("PL from Naive Reversing system subtracted from results generated by a trading system based on ARIMA/k-NN closing price forecasts.",
