...
cap <- c("Results from Naive Reversing System subtracted from results generated from predicting Up/Down categorical label using ARIMA/k-NN.",
         "Naive Reversing System subtracted from ARIMA/k-NN predictions")
...
dig <- 0
cap <- c("Results from Naive Reversing System subtracted from results generated from predicting Up/Down categorical label using ARIMA/SVM.",
         "Naive Reversing System subtracted from ARIMA/SVM predictions")
