...
Figure \ref{fig:acf80} is the correlogram of a data set built-in to R, called AirPassenger, over a range of lags from 1 to 80 and Figure \ref{fig:pacf} is the correlogram of the seasonal component of this data set.
