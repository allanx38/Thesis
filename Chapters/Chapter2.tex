...
\begin{figure}[tbph!]
\centering
\includegraphics[width=9cm]{../Figures/Chapter2/Candlestick_Patterns}
...
\subsubsection{Candlesticks Are visualisations}
\label{candle.todo1}

\subsubsection{What Candlesticks Don't Say}
\label{candle.todo2}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=12cm]{chp2_TimeSeriesComponents}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=8cm]{chp2_Stationary_ts}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=8cm]{chp2_Add2_ts}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=8cm]{chp2_Multi_ts}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=8cm]{chp2_HW1a}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=8cm]{chp2_HW2a}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=8cm]{chp2_HW3a}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=10cm]{chp2_acf80}
...
\begin{figure}[tbph!]
\centering
\includegraphics[width=10cm]{chp2_p_correlogram}
