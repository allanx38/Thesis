...
None of the candlestick patterns produced good results in the trading algorithms and time frames used. Given the subjective nature of what constitutes the particular pattern and the context in which it occurs it is difficult to programmatically generate trading systems. Further, it may be beneficial to alter the trading time frame to a longer period and perhaps combine these patterns with additional technical analysis indicators, and is a an area suitable for further work. 
...
\input{Tables/chp_ts_predUpDn_CAT_arima_svm_sys_chp6.tex}
