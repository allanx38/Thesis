...
Chapter 5 continued the exploration of financial time series through the use of ARIMA and hybrid ARIMA techniques. The generated models were used to create one-step forecasts which were then added to the original data sets. These ammended data sets were then fed into trading algorithms which used the forecast values to make trading decisions.
