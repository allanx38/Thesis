...
Figure \ref{fig:chp_ts_ftse_2000_13_diff_acf} is the ACF / PACF
...
\subsection{Try your chosen model(s)}

See Table \ref{tab:chp_ts:arima_res_r}
%label - tab:chp_ts:arima_res_r
\input{Tables/chp_ts_arima_res_r.tex}

\section{Rapid Miner Arima}
