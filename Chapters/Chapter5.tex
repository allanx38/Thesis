...
Table \ref{tab:chp_ts:arima2} lists the results from passing the data sets with the forecasts described in the previous section to the System 2 algorithm.
