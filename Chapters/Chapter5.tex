...
Figure \ref{fig:chp5_ts_dax} is a plot of the forecast from these models generated against the raining set and forecasting the closing price at the end of the test period. The Naive and Drift algorithms forecast similar values while the Mean method produces a markedly lower value.
...
See Table \ref{tab:es_drift_sys}

%label - tab:es_drift_sys
\input{Tables/chp_ts_es_drift.tex}

\subsection{Exponential Smoothing System}

See Table \ref{tab:es_sys}
