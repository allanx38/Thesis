...
Data from a variety of national stock market indices was employed in this study. The indices were from a variety of geographic locations with FTSE (UK), DAX (Germany) and CAC (France) all being in Europe, the Dow is from the US, the Nikkei from Japan and AORD from Australia. Stock market indices are calculated from the combined price movements within a group of shares, with the best known examples being calculated from companies with large market valuations. The indices used in this study were:

\begin{itemize}
\item FTSE - also referred to as the FTSE 100, these are the largest 100 companies by market capitalisation on the London Stock Exchange.
\item DAX - an index of the 30 primary companies trading on the Frankfurt Stock Exchange.
\item CAC - the most widely used French index containing the 40 largest stocks on the Euronext Paris (formerly the Paris Bourse), including companies such as L'Oreal and Renault.
\item Dow - also known as the Dow Jones Industrial Average is an index of 30 large publicly owned companies in the US, and reflects how they have traded in a standard trading session on the New York Stock Exchange.
\item Nikkei - also known as the Nikkei 225, it is the most widely quoted index for Japanese stocks traded on the Tokyo Stock Exchange.
\item AORD - also known as the All Ordinaries Index, it consists of the 500 largest companies by market capitalisation on the on the Australian Securities Exchange.
\end{itemize}
...
%label - tab:daxhead
\input{Tables/chp_3_1_daxhead.tex}
...
%label - tab:daxtail
\input{Tables/chp_3_1_daxtail.tex}
