...
For hundreds of years speculators have tried to make a profit from the financial markets by predicting their future movements. To this end, many methods and techniques have been developed that purport to assist the market participant in generating profits. This study reports on the effectiveness of several such techniques to help predict the one-step ahead forecasts of a range of national stock market indices (DAX, FTSE, CAC, Dow Jones, Nikkei and AORD). A selection of technical analysis indicators as well as more traditional time series prediction models such as exponential smoothing, ARIMA and hybrid ARIMA techniques are explored. Results from the predictive models are passed to trading algorithms where purchasing decisions are directed by the forecasts. In general the forecasts and models developed had limited predictive capabilities on the financial markets tested, however profitable systems were developed based on predictions from technical analysis and hybrid ARIMA models.
}
...
I wish to thank my supervisor Dr Geraldine Gray for her guidance, support and patience throughout the completion of this project. I would also like to acknowledge Dr Markus Hofmann and Laura Keyes, who along with Geraldine provided two years of stimulating and enjoyable lectures.
